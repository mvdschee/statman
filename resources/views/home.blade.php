...
@section('content')
    ...
    <section class="features">
        ...
        <div class="features-group">
            ...
            <div class="features-item">
                <img class="features-image" src="{{ URL::asset("/resources/assets/img/storyworld.jpg") }}" alt="">
                <h3>Storyworld</h3>
            ...
            <div class="features-item">
                <img class="features-image" src="{{ URL::asset("/resources/assets/img/smartphone.jpg") }}" alt="">
                <h3>Social Media</h3>
            ...
            <div class="features-item">
                <img class="features-image" src="{{ URL::asset("/resources/assets/img/security.jpg") }}" alt="">
                <h3>Security</h3>
    ...
    <section class="promo">
      <figure class="image" style="background-image: url({{ URL::asset("/resources/assets/img/promo.jpg") }});">
      </figure>
      <article class="text">
    ...
    <section class="team">
      <figure class="image" style="background-image: url({{ URL::asset("/resources/assets/img/athletes.jpg") }});">
      </figure>
      <article class="text">
